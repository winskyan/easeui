...
public class EaseMessageMenuData {
    ...
    public static final int[] MENU_ITEM_IDS = {R.id.action_chat_copy, R.id.action_chat_delete, R.id.action_chat_recall, R.id.action_chat_translate, R.id.action_chat_reTranslate, R.id.action_chat_hide};
    public static final int[] MENU_TITLES = {R.string.action_copy, R.string.action_delete, R.string.action_recall, R.string.action_translate, R.string.action_reTranslate, R.string.action_hide};
    public static final int[] MENU_ICONS = {R.drawable.ease_chat_item_menu_copy, R.drawable.ease_chat_item_menu_delete, R.drawable.ease_chat_item_menu_recall, R.drawable.ease_chat_item_menu_translation, R.drawable.ease_chat_item_menu_translation, R.drawable.ease_chat_item_menu_hide};
